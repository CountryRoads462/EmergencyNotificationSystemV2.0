...
public class CallBackData {
    public final static String ADD_CONTACT_CALL_BACK = "$add.contact";
    public final static String CREATE_TEMPLATE_CALL_BACK = "$create.template";
    public final static String SETTINGS_CALL_BACK = "$settings";
    public final static String SEND_EMERGENCY_MESSAGE_CALL_BACK = "$send.emergency.message";
    ...
    public final static String CHANGE_THE_TEMPLATE_TEXT_CALL_BACK = "$change.the.template.text";
